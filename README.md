...
**Note: When using a braces inside of a conditional there CANNOT be any whitespace after the opening brace, or before the closing brace of the callback tag within the conditional.  Doing so will result in errors.**
